import { ChatTeardrop, X } from "solid-phosphor";
import { For, Show } from "solid-js";
import { EntryCommentItem } from "@/components/entries";
...
const Actions = (props: {
	...
	return (
		<div class="justify-between flex items-center w-full">
			<Button onClick={props.onClose} variant="outline-lightgray" size="md-icon">
				<X />
			</Button>
