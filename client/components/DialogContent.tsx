...
export const DialogContent = ({
	...
	<BaseDialog.Portal>
		...
		<BaseDialog.Popup
			{...props}
			className="fixed flex flex-col gap-3 top-0 inset-x-0 translate-y-0 shadow-xl bg-background/90 backdrop-blur-xs text-foreground p-3 min-h-1/3 max-h-2/3 overflow-y-scroll border-b rounded-b-xl transition-transform duration-300 ease-out data-[starting-style]:-translate-y-full data-[ending-style]:-translate-y-full"
		>
			{children}
		</BaseDialog.Popup>
	</BaseDialog.Portal>
